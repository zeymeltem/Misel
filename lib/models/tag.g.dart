...
extension GetTagCollection on Isar {
  IsarCollection<int, Tag> get tags => this.collection();
}

final TagSchema = IsarGeneratedSchema(
  schema: IsarSchema(
    name: 'Tag',
    idName: 'id',
    embedded: false,
    properties: [
      ...
      IsarPropertySchema(name: 'colorIndex', type: IsarType.long),
    ],
    indexes: [
      IsarIndexSchema(
        name: 'name',
  ...
  converter: IsarObjectConverter<int, Tag>(
...
int serializeTag(IsarWriter writer, Tag object) {
  ...
  IsarCore.writeLong(writer, 2, object.colorIndex);
  return object.id;
}
...
Tag deserializeTag(IsarReader reader) {
  ...
  object.colorIndex = IsarCore.readLong(reader, 2);
  return object;
}
...
sealed class _TagUpdate {
  bool call({required int id, String? name, int? colorIndex});
}

class _TagUpdateImpl implements _TagUpdate {
  const _TagUpdateImpl(this.collection);

  final IsarCollection<int, Tag> collection;
  ...
  bool call({
    ...
    return collection.updateProperties(
          [id],
          {
            ...
            if (colorIndex != ignore) 2: colorIndex as int?,
          },
        ) >
        0;
  }
...
sealed class _TagUpdateAll {
  int call({required List<int> id, String? name, int? colorIndex});
}
...
extension TagUpdate on IsarCollection<int, Tag> {
...
sealed class _TagQueryUpdate {
  int call({String? name, int? colorIndex});
}
...
class _TagQueryUpdateImpl implements _TagQueryUpdate {
  ...
  @override
  int call({Object? name = ignore, Object? colorIndex = ignore}) {
...
extension TagQueryFilter on QueryBuilder<Tag, Tag, QFilterCondition> {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> idGreaterThan(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> idGreaterThanOrEqualTo(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> idLessThan(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(LessCondition(property: 0, value: value));
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> idLessThanOrEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorIndexEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorIndexGreaterThan(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorIndexGreaterThanOrEqualTo(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorIndexLessThan(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(LessCondition(property: 2, value: value));
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorIndexLessThanOrEqualTo(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorIndexBetween(
    int lower,
    int upper,
  ) {
    return QueryBuilder.apply(this, (query) {
...
extension TagQuerySortBy on QueryBuilder<Tag, Tag, QSortBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> sortByColorIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(2);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> sortByColorIndexDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQuerySortThenBy on QueryBuilder<Tag, Tag, QSortThenBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> thenByColorIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(2);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> thenByColorIndexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(2, sort: Sort.desc);
    });
  }
...
extension TagQueryWhereDistinct on QueryBuilder<Tag, Tag, QDistinct> {
  ...
  QueryBuilder<Tag, Tag, QAfterDistinct> distinctByColorIndex() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQueryProperty1 on QueryBuilder<Tag, Tag, QProperty> {
  QueryBuilder<Tag, int, QAfterProperty> idProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, int, QAfterProperty> colorIndexProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQueryProperty2<R> on QueryBuilder<Tag, R, QAfterProperty> {
  QueryBuilder<Tag, (R, int), QAfterProperty> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addProperty(0);
    });
  }
  ...
  QueryBuilder<Tag, (R, int), QAfterProperty> colorIndexProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addProperty(2);
    });
  }
...
extension TagQueryProperty3<R1, R2>
  ...
  QueryBuilder<Tag, (R1, R2, int), QOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addProperty(0);
    });
  }
  ...
  QueryBuilder<Tag, (R1, R2, int), QOperations> colorIndexProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addProperty(2);
    });
  }
